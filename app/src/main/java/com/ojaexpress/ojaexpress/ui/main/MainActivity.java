...
import com.ojaexpress.ojaexpress.ui.categories.CategoriesActivity;
import com.ojaexpress.ojaexpress.ui.home.HomeFragment;
import com.ojaexpress.ojaexpress.ui.login.LoginActivity;
import com.ojaexpress.ojaexpress.utils.ScreenUtils;
...
public class MainActivity extends BaseActivity implements MainMvpView {
    ...
    public void onBackPressed() {
        ...
        if (fragment == null) {
            ...
            onFragmentDetached(HomeFragment.TAG);
        }
    }
        ...
        mNavigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.nav_home:
                                mPresenter.onDrawerOptionHomeClick();
                                return true;
                            case R.id.nav_oja:
                                mPresenter.onDrawerOptionStoreClick();
                                return true;
                            case R.id.nav_stores:
                                mPresenter.onDrawerCateClick();
                                return true;
  ...
  @Override
    public void openMyCategoriesActivity() {
